 ...
 * 
 * It is responsible for reading and parsing the flightbook zip file.
 * It will pass the data straight to the static class FlightData.
 * 
...
public class ParseFlightBook {
	...
	public static boolean bookLoaded = false;
		...
		try {
			...
			xpp.setInput(input, null);
	         ...
	         while (xpp.getEventType() != XmlPullParser.END_DOCUMENT) {
	        	 ...
	        	 while (!(xpp.getEventType() == XmlPullParser.END_TAG && xpp.getName().equals("JFlight"))) {
	        		 ...
	        		 if(xpp.getEventType() == XmlPullParser.START_TAG ) {
	        			 ...
	        			 if (FlightData.identis.hasKey(key)) {
	        				 ...
	        				 if (xpp.getDepth() > jFlightDepth && xpp.getAttributeCount() > 0) {
	 ...
	 * @throws Exception
	 */
	private static Map<String,String> getRecentAttributes(XmlPullParser xpp) throws Exception {
	 ...
	 * @throws Exception
	 */
	private static Map<String,String>  getAttributes(XmlPullParser xpp) throws Exception {
	    Map<String,String> attrs=null;
